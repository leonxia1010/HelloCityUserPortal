...
describe('BannerText', () => {
  ...
  **/
  it('Render titles with correct typographys', () => {
    expect(screen.getByRole('heading', {name: /Navigate your new city with/, level: 2})).toBeInTheDocument();
    expect(screen.getByText('confidence')).toHaveStyle({color: 'rgb(25, 118, 210)'});
  })

  it('Renders the correct text with line breaks', () => { // TODO: 测试的所有名称都必须首字母大写
    expect(
